...
def main_prediction():
    ...
    plot_results(rgb_img, color_map, x_start, y_start, x_end, y_end, save_path="data/samples/selection13/merged/5wd.png")
    ...
    save_classification_to_tif(
        ...
        out_tif_path="data/samples/selection13/merged/5wd.tif",
    ...
    plot_feature_importances(clf, 
                         save_path="data/samples/selection13/merged/features_5wd.png", 
