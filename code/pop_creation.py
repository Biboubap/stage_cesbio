...
if __name__ == "__main__":
    ...
    pop_lichen_1.fill_neighbors_colors(depth_neighbors=1)
    pop_lichen_1.fill_slope(depth_neighbors=1)
    ...
    pop_lichen_2.fill_neighbors_colors(depth_neighbors=1)
    pop_lichen_2.fill_slope(depth_neighbors=1)
