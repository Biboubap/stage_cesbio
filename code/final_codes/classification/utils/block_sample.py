...
class BlockSample:
    ...
    Represents a patch within a block and calculates its statistics.
    """
    def __init__(self, i_x, i_y, x, y, size_patch, block_rasters):
        ...
        Args:
            i_x, i_y: Sample indices
            x, y: Coordinates within the block
            size_patch: Size of the patch
            block_rasters: BlockRastersManager instance
        """
        # Sample identifiers
        self.i_x = i_x
        self.i_y = i_y
    ...
    def compute_neighbors(self, samples_dict, block_rasters, distance_large=3):
        ...
        Args:
            samples_dict: Dictionary of samples indexed by (i_x, i_y)
            block_rasters: BlockRastersManager instance
            distance_large: Distance for large neighborhood
        """
        ...
        # --- Voisinage 1 ---
        # Use lists to collect valid values
        ...
        for i in range(-1, 2):
            for j in range(-1, 2):
                ...
                if neighbor is not None:
                    ...
                    # Calculate stats directly from block_rasters
