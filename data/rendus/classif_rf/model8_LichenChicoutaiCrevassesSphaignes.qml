...
<qgis hasScaleBasedVisibilityFlag="0" maxScale="0" version="3.22.4-Białowieża" minScale="1e+08" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" nodataColor="" type="paletted" opacity="1" band="1">
      ...
      <colorPalette>
        <paletteEntry color="#000000" alpha="255" value="0" label="0"/>
        <paletteEntry color="#b9c4c5" alpha="255" value="1" label="1"/>
        <paletteEntry color="#22a120" alpha="255" value="2" label="2"/>
        <paletteEntry color="#2c2a37" alpha="255" value="3" label="3"/>
        <paletteEntry color="#bc7b2b" alpha="255" value="4" label="4"/>
      </colorPalette>
