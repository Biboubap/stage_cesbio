  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" nodataColor="" type="paletted" opacity="1" band="1">
      ...
      <colorPalette>
        ...
        <paletteEntry color="#006400" alpha="255" value="1" label="1"/>
        <paletteEntry color="#998800" alpha="255" value="2" label="2"/>
        <paletteEntry color="#32cd32" alpha="255" value="3" label="3"/>
        <paletteEntry color="#c8c8c8" alpha="255" value="4" label="4"/>
        <paletteEntry color="#8b4513" alpha="255" value="5" label="5"/>
        <paletteEntry color="#505050" alpha="255" value="6" label="6"/>
        <paletteEntry color="#322d0a" alpha="255" value="7" label="7"/>
